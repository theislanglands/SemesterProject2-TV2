...
INSERT INTO credit_name (first_name, last_name, address, phone, email, date_of_birth, country, bio) VALUES ('Anette', 'Støvelbæk', 'Enghavevej 51', 32641190, 'anette@credits.dk', '1967-07-27','Danmark', 'Anette Støvelbæk er en dansk skuespiller. Hun fik sit gennembrud med rollen som Olympia i Lone Scherfigs film Italiensk for begyndere. På tv har hun medvirket i TV 2-serien Forsvar, og som Frk. Toft i DR-serien Krøniken. Ydermere spiller hun lægen Astrid Borg i TV-serien Lærkevej. Anette Støvelbæk er endvidere tilknyttet lydbogsforlaget Momo - Skuespillernes Lydbogsværksted, hvor hun har indlæst flere lydbøger. - https://da.wikipedia.org/wiki/Anette_St%C3%B8velb%C3%A6k');
